...
type Client interface {
	CreateUser(ctx context.Context, req *demouser.CheckUserRequest, callOptions ...callopt.Option) (r *demouser.CreateUserResponse, err error)
...
func (p *kUserServiceClient) CreateUser(ctx context.Context, req *demouser.CheckUserRequest, callOptions ...callopt.Option) (r *demouser.CreateUserResponse, err error) {
