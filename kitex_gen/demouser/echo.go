...
const (
	...
	ErrCode_ServiceErrCode             ErrCode = 100001
	ErrCode_ParamErrcode               ErrCode = 100002
	ErrCode_UserAlreadyExistErrCode    ErrCode = 100003
	ErrCode_AuthorizationFailedErrCode ErrCode = 1000004
)
...
type User struct {
	...
	Avator   string `thrift:"avator,3" frugal:"3,default,string" json:"avator"`
}
...
func (p *User) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("avator", thrift.STRING, 3); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *User) DeepEqual(ano *User) bool {
	...
	if !p.Field3DeepEqual(ano.Avator) {
		return false
	}
	return true
}
...
func (p *MGetUserResponse) GetUserIds() (v []int64) {
	return p.UserIds
}
...
func (p *MGetUserResponse) SetUserIds(val []int64) {
	p.UserIds = val
}
...
func (p *MGetUserResponse) Field1DeepEqual(src []int64) bool {
...
type UserService interface {
	CreateUser(ctx context.Context, req *CheckUserRequest) (r *CreateUserResponse, err error)
...
func (p *UserServiceClient) CreateUser(ctx context.Context, req *CheckUserRequest) (r *CreateUserResponse, err error) {
...
var UserServiceCreateUserArgs_Req_DEFAULT *CheckUserRequest

func (p *UserServiceCreateUserArgs) GetReq() (v *CheckUserRequest) {
	if !p.IsSetReq() {
		return UserServiceCreateUserArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *UserServiceCreateUserArgs) SetReq(val *CheckUserRequest) {
	p.Req = val
}
...
func (p *UserServiceCreateUserArgs) Field1DeepEqual(src *CheckUserRequest) bool {
