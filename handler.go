...
import (
	"context"
	demouser "example/kitex_gen/demouser"
)
...
func (s *UserServiceImpl) CreateUser(ctx context.Context, req *demouser.CheckUserRequest) (resp *demouser.CreateUserResponse, err error) {
	// TODO: Your code here...
	return
}
